...
async def run_ocr(file: Optional[UploadFile] = File(None), image_url: Optional[str] = Form(None),
    ...
    if file:
        ...
        # test image url: https://raw.githubusercontent.com/katanaml/sparrow/main/ml-data/docs/input/invoices/processed/images/invoice_10.jpg
        # test PDF: https://raw.githubusercontent.com/katanaml/sparrow/main/ml-data/docs/input/receipts/2021/us/bestbuy-20211211_006.pdf
