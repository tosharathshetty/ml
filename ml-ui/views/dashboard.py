...
class Dashboard:
    ...
    def view(self, model):
        ...
        api_url = "http://ml-inference-api:8080/api-inference/v1/ml-train-test-inference/statistics"
        json_data_inference = []
        ...
        api_url_t = "http://ml-inference-api:8080/api-training/v1/ml-train-test-inference/statistics/training"
        json_data_training = []
        ...
        api_url_e = "http://ml-inference-api:8080/api-training/v1/ml-train-test-inference/statistics/evaluate"
        json_data_evaluate = []
        ...
        with st.container():
            ...
            with col2:
                with st.container():
                    ...
                    api_url = "http://ml-inference-api:8080/api-dataset/v1/ml-data/dataset_info"
